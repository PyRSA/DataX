...
public abstract class HbaseAbstractTask {
    ...
    public HbaseAbstractTask(com.alibaba.datax.common.util.Configuration configuration) {
        ...
        this.bufferedMutator = Hbase23xHelper.getBufferedMutator(configuration);
    ...
    public void startWriter(RecordReceiver lineReceiver, TaskPluginCollector taskPluginCollector){
        ...
        try {
            ...
            throw DataXException.asDataXException(Hbase23xWriterErrorCode.PUT_HBASE_ERROR,e);
        }finally {
            //Hbase11xHelper.closeTable(this.htable);
            Hbase23xHelper.closeBufferedMutator(this.bufferedMutator);
        }
    }
        ...
        if(column.getRawData() != null){
            switch (columnType) {
                ...
                case STRING:
                    ...
                    break;
                default:
                    throw DataXException.asDataXException(Hbase23xWriterErrorCode.ILLEGAL_VALUE, "HbaseWriter列不支持您配置的列类型:" + columnType);
            }
        }else{
            switch (nullMode){
                case Skip:
                ...
                case Empty:
                    ...
                    break;
                default:
                    throw DataXException.asDataXException(Hbase23xWriterErrorCode.ILLEGAL_VALUE, "HbaseWriter nullMode不支持您配置的类型,只支持skip或者empty");
            }
        }
        return  bytes;
    }
